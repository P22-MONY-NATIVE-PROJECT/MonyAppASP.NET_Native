...
[ApiController]
[Route("api/saving-categories")]
public class SavingCategoriesController(IMediator mediator) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> Get()
        => Ok(await mediator.Send(new GetCategoriesQuery(CategoryTypeIds.Saving)));
        ...
        [FromForm] CreateCategoryDto dto)
    {
        return Ok(await mediator
            .Send(new CreateCategoryCommand(dto, CategoryTypeIds.Saving)));
    }
